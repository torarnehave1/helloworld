...
// ../.wrangler/tmp/bundle-2QHgXm/checked-fetch.js
...
async function onRequest(context) {
  ...
  try {
    ...
    const token = authHeader?.replace("Bearer ", "") || getCookie(request, "vegvisr_token");
    if (!token) {
...
// ../.wrangler/tmp/pages-MVXpoW/functionsRoutes-0.048738528968742756.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-2QHgXm/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-2QHgXm/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.13827757592371248.mjs.map
